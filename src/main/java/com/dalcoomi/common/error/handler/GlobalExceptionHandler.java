package com.dalcoomi.common.error.handler;

import static com.dalcoomi.common.error.model.ErrorMessage.INPUT_VALUE_IS_INVALID;
import static com.dalcoomi.common.error.model.ErrorMessage.INVALID_REQUEST_BODY;
import static com.dalcoomi.common.error.model.ErrorMessage.MAX_UPLOAD_SIZE_EXCEEDED;
import static com.dalcoomi.common.error.model.ErrorMessage.MISSING_REQUIRED_PARAMETER_ERROR;
import static com.dalcoomi.common.error.model.ErrorMessage.PARAMETER_FORMAT_NOT_CORRECT;
import static com.dalcoomi.common.error.model.ErrorMessage.SERVER_ERROR;
...
public class GlobalExceptionHandler {
	...
	protected ErrorResponse handleUnauthorizedException(DalcoomiException exception) {
		log.error(exception.getMessage(), exception);
