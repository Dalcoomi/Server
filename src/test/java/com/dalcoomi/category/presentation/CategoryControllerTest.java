...
class CategoryControllerTest {
	...
	void get_my_category_with_transaction_type_success() throws Exception {
		...
		mockMvc.perform(get("/api/category/my")
			...
			.andExpect(jsonPath("$.categories[1].name").value(category1.getName()))
			.andExpect(jsonPath("$.categories[2].name").value(category2.getName()))
			.andExpect(jsonPath("$.categories[0].iconUrl").value(category3.getIconUrl()))
			.andExpect(jsonPath("$.categories[1].iconUrl").value(category1.getIconUrl()))
			.andExpect(jsonPath("$.categories[2].iconUrl").value(category2.getIconUrl()))
